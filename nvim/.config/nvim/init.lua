...
do
  ...
  require('which-key').setup {
    ...
    spec = {
      { '<leader>f', group = 'Search', mode = { 'n', 'v' } },
  ...
  vim.pack.add { 'https://github.com/ReezanVisram/monokai-pro.nvim' }
...
do
  ...
  vim.keymap.set({ 'n', 'v' }, '<leader>fw', builtin.live_grep, { desc = 'Live Grep' })
  vim.keymap.set('n', '<leader>fg', builtin.grep_string, { desc = 'Search by Grep' })
...
-- ============================================================
-- SECTION 9: FILE NAVIGATION
-- File Tree, Bufferline, etc.
-- ============================================================
do
  vim.pack.add({
